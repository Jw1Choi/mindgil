$(document).ready(function(){
    ...
    $('#send_message').click(function(){
        ...
        $('#name,#phone,#problem1,#agree11,#position,#email, #selectedOption, #selectedOption1').click(function(){
...
function maxLengthCheck(object){
 ...
 function form_check(){
                ...
                //     {
                             if (option1.length > 1 /*&& regex3.test(hope1)*/)
                            {
                                ...
                                else
                                {
                                    $('#send_message').css({transition:"1s"});
                                    $('#send_message').prop("disabled", true);
                                    $('#send_message').prop("value", "소망 선택을 확인하세요.");
                                    $('#send_message').css({background:"#595959"});
                                    $('#send_message').css({cursor:"default"});        
                                }                               
    ...
    else
    {
        $('#send_message').css({transition:"1s"});
        $('#send_message').prop("disabled", true);
        $('#send_message').prop("value", "고민 선택을 확인하세요.");
        $('#send_message').css({background:"#595959"});
        $('#send_message').css({cursor:"default"});        
    }
 }
...
$(function(){
 $('#name,#phone,#problem1,#problem2,#problem3,#hope1,#hope2,#hope3,#agree11,#question3,#question4,#age, #dropdown, #email, #selectedOption, #selectedOption1, .option, .option1').bind("keyup click change",form_check);
